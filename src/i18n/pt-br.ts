...
export const ptBr: Translations = {
  ...
  home: {
    ...
    backend: 'Backend',
    frontend: 'Frontend',
    toolsAndPractices: 'Ferramentas e Práticas',
    latestNotes: 'Notas Recentes',
    allNotes: 'Todas as notas →',
    experienceEducation: 'Experiência e Formação',
    fullExperience: 'Experiência completa e CV →',
  },
  about: {
    label: 'Sobre',
    title: 'Quem sou eu',
    description: 'Uma visão geral da minha formação, do que trabalho e para onde estou indo.',
    background: 'Formação',
    currentFocus: 'Foco Atual',
    careerObjective: 'Objetivo de Carreira',
    education: 'Educação',
    professionalBackground: 'Trajetória Profissional',
  ...
  contact: {
    ...
    description:
      'Aberto a conversas sobre vagas de engenharia, colaborações e projetos técnicos.',
    email: 'E-mail',
    github: 'GitHub',
    linkedin: 'LinkedIn',
    cv: 'CV',
  ...
  experience: {
    ...
    description:
      'Registro de funções profissionais, formação acadêmica e áreas de foco técnico.',
